...
const NewsArticle = () => {
  ...
  return (
    <MainLayout>
      <div className="flex">
        {/* Article list */}
        <div className="w-1/5 bg-blue-200 hidden lg:flex self-start mr-1">
          Test
        </div>

        <div className="w-full lg:w-4/5">
          <div
            className="h-40 flex flex-col justify-between bg-center border-b-2 dark:border-gray-800 border-gray-400 w-full"
            style={{
